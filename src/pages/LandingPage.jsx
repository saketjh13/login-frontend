...
const LandingPage = () => {
    ...
    return (
        <div className="flex flex-col md:flex-row w-full h-screen overflow-hidden">
            ...
            <div className="w-full md:w-2/5 flex flex-col justify-center items-center px-6 md:px-16 bg-[conic-gradient(at_top_left,_#96cef8,_#bb9fce,_#f7a2bb,_#65abe9)]">
            ...
            <div className="relative hidden md:flex w-3/5 h-full items-center justify-end px-10">
